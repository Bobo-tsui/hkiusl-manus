...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "slot.star-guest": { zh: "星級嘉賓", en: "Star Guest" },
  ...
  "d1.s7.desc": { zh: "西DorSi 現場分享自媒體創業經驗與個人品牌建立心得。", en: "SaiDorSi shares self-media entrepreneurship experience and personal branding insights in person." },
  ...
  "d2.s5.title": { zh: "大隊長駕到", en: "Captain Arrives" },
  ...
  "d2.s6.title": { zh: "Networking / LUNCH", en: "Networking / LUNCH" },
  ...
  "signup.deposit": { zh: "按金（可退還）", en: "Deposit (Refundable)" },
  "signup.deposit.note": { zh: "活動完成後 7 天內全額退還", en: "Full refund within 7 days after event completion" },
  "signup.hkmu": {
  ...
  "signup.deadline": { zh: "報名截止日期：2026 年 4 月 10 日 20:00", en: "Registration deadline: April 10, 2026 20:00" },
